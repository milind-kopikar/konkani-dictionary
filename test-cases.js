...
const TEST_CASES = {
  ...
  "aamchigele": {
    ...
    context_usage_sentence: "आम्चिगेले उल्लव्या"
  },
  ...
  "kalosk": {
    entry_number: 4,
    word_konkani_devanagari: "काळोsक",
    word_konkani_english_alphabet: "[काळोsक]",
...
const LLM_TEST_QUERIES = [
  ...
  
  {
    ...
    expected_entries: [2336, 2339], // Should return उद्दाक, उद्धा
    should_not_contain: ["उदक", "जळ", "नीर"] // These don't exist in DB
  },
